...
schemas = [subscene_rec, visualWM, perceptLTM, conceptualizer, conceptLTM, grammaticalLTM, cxn_retrieval, semanticWM, grammaticalWM, phonWM, control] 
...
grammaticalWM.dyn_params['tau'] = 100
...
grammaticalWM.C2_params['prune_threshold'] = 0.1
...
control.task_params['time_pressure'] = 20
