...
from schema_theory import KNOWLEDGE_SCHEMA, SCHEMA_INST, MODULE_SCHEMA, LTM, WM
import viewer
import scene as scn
...
#################################
### PERCEPTUAL MODULE SCHEMAS ###
#################################
#class SALIENCY_MAP(MODULE_SCHEMA):
#    """
#    Data:
...
#
#class SACCADE_SYSTEM(MODULE_SCHEMA):
#    """
#    """
...
class SUBSCENE_RECOGNITION(MODULE_SCHEMA):
    """
...
class SIMPLE_SALIENCY_MAP(MODULE_SCHEMA):
    """
    Data:
        - BU_saliency_map (array): BOTTOM-up saliency data generated by Itti-Koch matlab saliency toolbox.
        - areas [AREA]:
