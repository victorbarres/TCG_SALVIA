...
class VISUAL_WM(WM):
    ...
    def __init__(self, name='Visual_WM'):
        ...
        self.C2_params = {'coop_weight':0.0, 'comp_weight':0.0, 'prune_threshold':0.01, 'confidence_threshold':0.0, 'coop_asymmetry':1, 'comp_asymmetry':0, 'P_comp':1.0, 'P_coop':1.0} # C2 is not implemented in this WM.
