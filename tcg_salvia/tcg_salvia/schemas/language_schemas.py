...
from ..neuro_st.schema_theory import KNOWLEDGE_SCHEMA, SCHEMA_INST, SYSTEM_SCHEMA, LTM, WM, ASSEMBLAGE
import construction
from ..utils import TCG_graph
...
#                self.SemRep.node[u]['concept'] = self.SemRep.node[v]['concept']
    ...
    def show_state(self):
        ...
        VIEWER.display_semWM_state(self, file_type='png', show=True)
