...
from ..neuro_st import schema_theory as st
from ..schemas import language_schemas as ls
from ..schemas import perceptual_schemas as ps
...
def TCG_production_system(name = 'language_system_P', 
    ...
    language_schemas = [conceptLTM, semanticWM_P, grammaticalLTM, cxn_retrieval_P, grammaticalWM_P, phonWM_P, utter, control]
    ...
    my_conceptual_knowledge = LOADER.load_conceptual_knowledge(semantics_file, semantics_path)
    grammar_file = "%s.json" %grammar_name
    my_grammar = LOADER.load_grammar(grammar_file, grammar_path, my_conceptual_knowledge)
...
def SALVIA_P(name='SALVIA_P',
   ...
   # Creating model and adding system schemas
    ...
    semantics_file = "%s.json" % semantics_name
    my_perceptual_knowledge = LOADER.load_perceptual_knowledge(semantics_file, semantics_path)
    my_conceptual_knowledge = LOADER.load_conceptual_knowledge(semantics_file, semantics_path)
    
    my_conceptualization = LOADER.load_conceptualization(semantics_file, semantics_path, my_conceptual_knowledge, my_perceptual_knowledge)
