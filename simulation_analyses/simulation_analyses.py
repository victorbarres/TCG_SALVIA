...
Test basics stats
Tests nunpy and pandas.
"""
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt

file_path = "./test_file1.csv"
...
plt.ylim(-0.5, 1.5)
plt.savefig('active.png', facecolor='w', edgecolor='w', format='png')
...
plt.ylim(-0.5, 1.5)
plt.savefig('passive.png', facecolor='w', edgecolor='w', format='png')
