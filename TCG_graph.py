...
def find_sub_multi_iso(G, G_subgraphs, G_pat, node_match=None, edge_match=None):
...
def find_max_partial_iso(G, G_subgraphs, G_pat, G_pat_subgraphs, node_match=None, edge_match=None):
