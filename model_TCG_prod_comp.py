...
def test(seed=None):
    ...
    language_system.schemas['Grammatical_WM_P'].show_dynamics(inst_act=True, WM_act=True, c2_levels=True,
                                                              c2_network=True)
    language_system.schemas['Grammatical_WM_C'].show_dynamics(inst_act=True, WM_act=True, c2_levels=True,
                                                              c2_network=True)
